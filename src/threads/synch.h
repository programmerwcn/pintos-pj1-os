...
struct lock 
  {
    ...
    /* max priority of threads waiting for the lock */
    int max_priority;
...
/* Compare the priority of thread waiting for lock a and lock b */
...
/* Compare the priority of thread waiting for condition a and b */
